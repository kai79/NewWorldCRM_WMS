Public Class ReportAddProductForm

    Private Sub ReportAddProductForm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        If strRptSelectedProd <> "" Then
            ...
            tempLib = Split(strRptSelectedProd, "|")
    ...
    Private Sub CfgAddProdSaveBtn_Click(sender As System.Object, e As System.EventArgs) Handles CfgAddProdSaveBtn.Click
        ...
        strRptSelectedProd = temp

        Me.Dispose()

    End Sub

    Private Sub NewMenuAddProdCancel_Click(sender As System.Object, e As System.EventArgs) Handles CfgAddProdCancel.Click
