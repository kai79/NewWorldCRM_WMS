Public Class ReportMenuAddMenuForm

    Private Sub ReportMenuAddMenuForm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        If strMenuRptSelectedMenu <> "" Then
            ...
            tempLib = Split(strMenuRptSelectedMenu, "|")
    ...
    Private Sub ReportMenuAddMenuForm_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
